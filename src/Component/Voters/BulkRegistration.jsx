...
const [students, setStudents] = useState([
    { name: "BANGURA ABUBAKARR", gender: "Male", feesCategory: "Continue" },
    { name: "KAMARA SALLIEU", gender: "Male", feesCategory: "Continue" },
    { name: "KOROMA ALNET M.", gender: "Female", feesCategory: "Continue" },
    { name: "JALLOH AMINATA C.", gender: "Female", feesCategory: "Continue" },
    { name: "BANGURA YUSUF A.", gender: "Male", feesCategory: "Continue" },
    { name: "BANGURA RAMATULAI K.", gender: "Female", feesCategory: "Continue" },
    { name: "KAMARA FATIMA S.", gender: "Female", feesCategory: "Continue" },
    { name: "KANU YABOM BINTA", gender: "Female", feesCategory: "Continue" },
    { name: "CONTEH ALBERTA L.", gender: "Female", feesCategory: "Continue" },
    { name: "COKER PATRICE J.", gender: "Female", feesCategory: "Continue" },
    { name: "FORNAH SAMUEL M.", gender: "Male", feesCategory: "Continue" },
    { name: "COLE PRINCESS M.M.T.", gender: "Female", feesCategory: "Continue" },
    { name: "NOOR NABILA", gender: "Female", feesCategory: "Continue" },
    { name: "KOROMA MARIAMA T.", gender: "Female", feesCategory: "Continue" },
    { name: "SESAY FATMATA D.", gender: "Female", feesCategory: "Continue" },
    { name: "CONTEH MARIAMA S.", gender: "Female", feesCategory: "Continue" },
    { name: "KOROMA ISREAL A.", gender: "Male", feesCategory: "Continue" },
    { name: "SESAY KHADIJAH EASTINA", gender: "Female", feesCategory: "Continue" },
    { name: "KAMARA ADAMA T.", gender: "Female", feesCategory: "Continue" },
    { name: "CONTEH MAGDALENE N.", gender: "Female", feesCategory: "Continue" },
    { name: "LEIGH ALNETTE L.", gender: "Female", feesCategory: "Continue" }
]);
