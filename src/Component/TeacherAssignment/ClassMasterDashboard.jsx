...
import AttendancePageClass from "./AttendancePageClass";
import PupilUpdate from "./PupilUpdate";


// Navigation Items
const NAV_ITEMS = [
  {
    key: "AttendancePageClass",
  ...
  const renderNavItems = (items) =>
   ...
   const renderContent = () => {
    switch (activeTab) {
      ...
      case "ClassList":
        return <PupilUpdate />;
      case "AttendancePageClass":
        return <AttendancePageClass />;
      // case "theory":
